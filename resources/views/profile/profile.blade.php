                    ...
                    <div class="col-md-9">
                        <div class="profile-content">
                            <div class="profile-course">
                                <div class="profile-course-title">My courses</div>
                                <div class="profile-course-detail">
                                    @foreach($profiles as $profile)
                                        <div class="profile-course-card">
                                            <div class="profile-course-img">
                                                <img src="{{ $profile->image }}" alt="image-course">
                                            </div>
                                            <p class="profile-course-name">{{ $profile->name }}</p>
                                        </div>
                                    @endforeach
                                    <div class="profile-course-card">
                                        <div class="profile-course-img profile-course-add">
                                            <a href="{{ route('courses.index') }}"><i class="fas fa-plus icon-add"></i></a>
                                        </div>
                                        <p class="profile-course-name">Add course</p>
                                    </div>
                                </div>
                                <div class="profile-course-title">Edit profile</div>
                                <div class="profile-edit">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="description" class="profile-label">About me</label>
